...
namespace Rotterdam.DigitalTwins.Editor
{
    ...
    /// </summary>
    public class MarkdownComponent : VisualElement
    {
        ...
        public MarkdownComponent(string title, string filePath, System.Action onBack)
        {
            _onBack = onBack;
            _title = title;
            ...
            Button backButton = new Button(_onBack) { text = "Back" };
